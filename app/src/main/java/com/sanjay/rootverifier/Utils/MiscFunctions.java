...
package com.sanjay.rootverifier.Utils;
...
import com.sanjay.rootverifier.MainActivity;
import com.sanjay.rootverifier.R;
    ...
    public static void rateOnPS() {
        ...
        try {
            intent = new Intent(Intent.ACTION_VIEW,
                    Uri.parse("market://details?id=com.sanjay.rootchecker"));
